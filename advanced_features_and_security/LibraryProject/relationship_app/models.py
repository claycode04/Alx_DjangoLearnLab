...
class Book(models.Model):
    ...
    class Meta:
        ...
        # Use @permission_required('relationship_app.can_edit', raise_exception=True) in views to enforce access control.
...
class Librarian(models.Model):
    ...
    # Remove UserProfile, roles can be handled via groups/permissions or added to CustomUser if needed
