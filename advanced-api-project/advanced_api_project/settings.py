# DRF global settings for filtering support
REST_FRAMEWORK = {
...
SECRET_KEY = 'django-insecure-q$pi76pj)wc%pg=%y2!tm%i=rnjpc-ft$qab0k+_-qs^nlygzm'
...
INSTALLED_APPS = [
    ...
    'django_filters',  # Added for DRF filtering support
